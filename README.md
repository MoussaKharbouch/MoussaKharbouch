...
I focus on designing systems with clear architecture, strong data integrity, and clean separation of concerns — applying practices that reflect real-world backend development.
...
### Languages
- C# (.NET) — application architecture, OOP, structured design
- C++ — problem solving and core programming fundamentals

### Data & Persistence
- SQL Server — schema design, normalization, query optimization  
- ADO.NET — low-level data access, parameterized queries, command handling  
